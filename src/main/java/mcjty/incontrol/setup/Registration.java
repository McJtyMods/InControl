...
import mcjty.incontrol.events.InControlLoodModifier;
...
public class Registration {
    ...
    public static final Supplier<MapCodec<? extends IGlobalLootModifier>> INCONTROL_GLM = LOOT_MODIFIER_SERIALIZERS.register("incontrol_glm", () -> InControlLoodModifier.CODEC);
