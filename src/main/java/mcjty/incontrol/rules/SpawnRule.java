...
public class SpawnRule extends RuleBase<RuleBase.EventGetter> {
    ...
    static {
        FACTORY
                ...
                .attribute(Attribute.createMulti(SPAWNTYPE))
                ...
                .attribute(Attribute.create(ACTION_KNOCKBACKSET))
                .attribute(Attribute.create(ACTION_KNOCKBACKMULTIPLY))
                .attribute(Attribute.create(ACTION_KNOCKBACKADD))
                .attribute(Attribute.create(ACTION_KNOCKBACKRESISTANCESET))
